...
public class BMWorldGen
{
	...
	private static void darkForestModifications()
	{
		...
		BiomeModifications.addFeature(DARK_FOREST, TOP_LAYER_MODIFICATION, rk(WILD_MUSHROOMS));
		BiomeModifications.addFeature(DARK_FOREST, TOP_LAYER_MODIFICATION, rk(ConfiguredFeatures.PATCH_GRASS_BADLANDS));
		BiomeModifications.addFeature(DARK_FOREST, TOP_LAYER_MODIFICATION, rk(DF_FLOWERS));
		BiomeModifications.addFeature(DARK_FOREST, TOP_LAYER_MODIFICATION, rk(DF_PATCH_TALL_GRASS));
	...
	private static void mushroomModifications()
	{
		...
		BiomeModifications.addFeature(MUSHROOM_BIOMES, VEGETAL_DECORATION, rk(WILD_MUSHROOMS));
	...
	public static final ConfiguredFeature<TreeFeatureConfig, ?> ANCIENT_OAK = Feature.TREE.configure((new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.DARK_OAK_LOG.getDefaultState()), new SimpleBlockStateProvider(Blocks.DARK_OAK_LEAVES.getDefaultState()), new LargeOakFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(0), 3), new AncientOakTrunkPlacer(10, 2, 14), new ThreeLayersFeatureSize(2, 3, 0, 1, 2, OptionalInt.empty())).decorators(ImmutableList.of(IvyTreeDecorator.INSTANCE))).maxWaterDepth(Integer.MAX_VALUE).heightmap(Heightmap.Type.MOTION_BLOCKING).ignoreVines().build());
	public static final ConfiguredFeature<TreeFeatureConfig, ?> ANCIENT_OAK_SMALL = Feature.TREE.configure((new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.DARK_OAK_LOG.getDefaultState()), new SimpleBlockStateProvider(Blocks.DARK_OAK_LEAVES.getDefaultState()), new LargeOakFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(2), 2), new LargeOakTrunkPlacer(8, 11, 2), new TwoLayersFeatureSize(2, 0, 0, OptionalInt.of(3))).decorators(ImmutableList.of(IvyTreeDecorator.INSTANCE, ConfiguredFeatures.Decorators.REGULAR_BEEHIVES_TREES))).ignoreVines().build());
	public static final ConfiguredFeature<TreeFeatureConfig, ?> DARK_OAK_SMALL = Feature.TREE.configure((new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.DARK_OAK_LOG.getDefaultState()), new SimpleBlockStateProvider(Blocks.DARK_OAK_LEAVES.getDefaultState()), new LargeOakFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(2), 2), new LargeOakTrunkPlacer(7, 8, 2), new TwoLayersFeatureSize(2, 0, 0, OptionalInt.of(3)))).decorators(ImmutableList.of(ConfiguredFeatures.Decorators.REGULAR_BEEHIVES_TREES)).ignoreVines().build());
	...
	public static final ConfiguredFeature<?, ?> DF_PEONY = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.PEONY.getDefaultState()), new DoublePlantPlacer())).tries(7).build());
	public static final ConfiguredFeature<?, ?> DF_LILAC = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.LILAC.getDefaultState()), new DoublePlantPlacer())).tries(7).build());
	public static final ConfiguredFeature<?, ?> DF_ROSE = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.ROSE_BUSH.getDefaultState()), new DoublePlantPlacer())).tries(7).build());
	public static final ConfiguredFeature<?, ?> DF_FOXGLOVE = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(BMBlocks.FOXGLOVE.getDefaultState()), new DoublePlantPlacer())).tries(7).build());
	public static final ConfiguredFeature<?, ?> DF_BLACK_THISTLE = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(BMBlocks.BLACK_THISTLE.getDefaultState()), new DoublePlantPlacer())).tries(7).build());
	public static final ConfiguredFeature<?, ?> DF_FLOWERS = Feature.SIMPLE_RANDOM_SELECTOR.configure(new SimpleRandomFeatureConfig(ImmutableList.of(()->DF_PEONY, ()->DF_LILAC, ()->DF_ROSE, ()->DF_BLACK_THISTLE, ()->DF_FOXGLOVE))).repeat(UniformIntDistribution.of(-1, 4)).decorate(ConfiguredFeatures.Decorators.SPREAD_32_ABOVE).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP);
	public static final ConfiguredFeature<?, ?> DF_PATCH_TALL_GRASS = Feature.RANDOM_PATCH.configure(ConfiguredFeatures.Configs.TALL_GRASS_CONFIG).decorate(ConfiguredFeatures.Decorators.SPREAD_32_ABOVE).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).repeat(14);

	public static final RandomPatchFeatureConfig WILD_MUSHROOM_CONFIG = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(BMBlocks.WILD_MUSHROOMS.getDefaultState()), SimpleBlockPlacer.INSTANCE)).tries(20).build();
	public static final ConfiguredFeature<?, ?> WILD_MUSHROOMS = Feature.RANDOM_PATCH.configure(WILD_MUSHROOM_CONFIG).decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP_SPREAD_DOUBLE).repeat(2);
